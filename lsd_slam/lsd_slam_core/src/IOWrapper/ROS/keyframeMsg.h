...
struct MD5Sum< ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator> >
{
  ...
  {
    return "fc9f40b5f4c1c45487f21b7189e76f22";
  }

  static const char* value(const ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfc9f40b5f4c1c454ULL;
  static const uint64_t static_value2 = 0x87f21b7189e76f22ULL;
};
